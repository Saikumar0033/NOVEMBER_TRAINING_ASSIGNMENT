package Exception_Q2;

import java.util.Arrays;
import java.util.Scanner;

public class Employee {
	public static void main(String[] args) throws LeaveExceedLimitException, EmployeeAbscondingException {
		double salary = 25000;
		...
		if (absent < 1) {
			if (noInfo >= 4) {
				if (isSequence(noinfoArr)) {
					...
					throw new EmployeeAbscondingException("Your salary will not be calculated");
				}
			} else if (leave > 2) {
